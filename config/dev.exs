...
config :dan_web, DanWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "m+eCaWDrpStLSBCG2RVIkpGUqe3yIhZjydtDY3C1sG6hIhDFCRZVq+09J+EpklPc",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:dan_ton, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:dan_ton, ~w(--watch)]}
  ]
